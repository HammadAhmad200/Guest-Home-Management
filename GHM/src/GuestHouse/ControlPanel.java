...
//            image.setIcon(icon);
    ...
    private void initComponents() {
        ...
        dcn.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        abd.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 430, 280, 36));
        ...
        jPanel1.add(cross, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 20, 20, 20));
    ...
    private void LTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LTActionPerformed
                if(confirmLI.isSelected()){    
       ImageIcon icon = new ImageIcon("src/images/logout2.png");
       int input = JOptionPane.showConfirmDialog(this, "Do you want to logout?", "Warning.....",
            JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, icon);
        if(input==0){ 
        logout.setSelected(false);
        logIn=false;
        new ControlPanel(logIn);
        login();
       }else{
           logIn=true;
           new ControlPanel(logIn);
    ...
    private void guestsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guestsActionPerformed
        ...
        if(logIn==true){
            ...
            resv.setLocationRelativeTo(null);
        ...
        // TODO add sajjadali your handling code here:
